...
{
    /// <summary>
    /// Represents an interaction script for classical mechanical electrodynamics
    ...
    public class Script : ParticleInteractionScript
    {
        ...
        public Script()
        {
            this.Tags = new string[] { "PostForceInteraction" };
            this.Name = "Classical Electrodynamics";
            this.Description = "An interaction script for classical mechanical electrodynamics. This script returns the Lorentz force of the electromagnetic field on the input particle.";
