...
namespace SimplexUniverse.Scripting
{
    public class Script : ParticleInteractionScript
    {
        public Script()
        {
            ...
            this.Name = "G+ Prince Istalri";
            this.Description = "F = k(qm)/(d^3)﻿";
        ...
        public override dynamic CalculateInteraction(Particle Input, Particle Comparison, Simulation Sim)
        {
            ...
            if (!Comparison.HasProperty("Charge") || !Comparison.HasProperty("Mass")) return Force;
            ...
            if (Sim.Parameters.HasParam("SofteningValue"))
            {
                ...
                Denominator = System.Math.Pow(((ActualDistance * ActualDistance) + (SofteningValue * SofteningValue)), (4.0 / 3.0));
            }
            else //Otherwise:
            {
                //Calculate the denominator of the equation
                Denominator = System.Math.Pow(((ActualDistance * ActualDistance)), (4.0 / 3.0));
            }
            ...
            for (int i = 0; i < Force.Capacity; i++)
            {
                ...
                Force[i] = k * (ComparisonCharge * ComparisonMass * ComponentDistance) / Denominator;
            }
