...
namespace SimplexUniverse.Scripting
{
    public class Script : SeedScript
    {
        public Script()
        {
            this.Name = "Random Position and Velocity with Automatic Properties";
            this.Description = "Randomizes the starting positions particles in a universe within the bounds of the universe and automatically initializes particle properties to double values within their minimum and maximum. Also randomly generates particle velocities between 1 and 2 Units/Generation. Supports sub-particles.";
        }
